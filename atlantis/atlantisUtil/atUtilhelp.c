/**
 \file
 \brief C file for helpful math routines for array sorting - used in economic and distance models for Atlantis
 \ingroup ateconomic

 File:	atUtilhelp.c (was ateconhelp.c)
 Author:	Beth Fulton
 Created:	7/10/2005 (renamed 4/12/2021)
 Purpose:	C file for helpful math routines for economic models for Atlantis
 Revisions: 25/10/2005 Created the file
 
 4/12/2021 renamed and moved to the Utillibrary
