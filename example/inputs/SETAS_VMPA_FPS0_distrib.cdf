...
variables:
	double t(t) ;
		...
		t:dt = 864000. ;
	double FPS_stage_0(t, b) ;
		FPS_stage_0:units = " " ;
		FPS_stage_0:_FillValue = 0.0 ;
		FPS_stage_0:missing_value = 0.0;
		FPS_stage_0:valid_min = 0.0;
		FPS_stage_0:valid_max = 1.0;
...
data:
 ...
 FPS_stage_0 =
    ...
    0, 0.3, 0.3, 0.3, 0.05, 0.05, 0, 0, 0, 0, 0;
   }
